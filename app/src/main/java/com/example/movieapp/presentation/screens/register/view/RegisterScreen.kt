package com.example.movieapp.presentation.screens.register.view
...
fun RegisterScreen(
    ...
    AuthForm(
        formTitle = stringResource(R.string.create_account),
        ...
        onOutlinedButtonClick = { navigationController.navigate(MovieAppRoutes.LoginScreen) },
        onFilledButtonClick = { viewModel.authenticate(isLogin = false) },
        isLoading = state.value.isLoading,
        canProceed = state.value.canProceed,
        outlinedButtonTitle = stringResource(R.string.login_instead),
        filledButtonTitle = stringResource(R.string.create_account),
        modifier = modifier
            .fillMaxSize()
